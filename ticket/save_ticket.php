...
";
    ...
    if ($mail->send()) {
        ...
        // Remove duplicates and filter numbers that are not exactly 10 digits
        ...
        // Re-index the array (optional, but useful for consistent array keys)
                ...
                "data" => [
                    ...
                    "context" => [
                        ...
                        "body" => [
                            ...
                            "4" => $ticket_data['contact_phone1'] . " - " . $ticket_data['contact_phone2'],
    ...
    ob_clean(); // Clear output buffer to ensure valid JSON
    echo json_encode(['status' => 'error', 'message' => $e->getMessage()]);
}
$conn->close();
ob_end_flush();
