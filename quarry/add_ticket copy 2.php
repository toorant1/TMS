...
<div class="form-container">
    ...
    <form method="POST" class="needs-validation" novalidate>
        <div class="row g-3">
            ...
            <div class="col-md-3">
                <label for="status" class="form-label">Ticket Type</label>
                <select id="status" name="status" class="form-select" required>
                    <option value="" disabled selected>Select Type</option>
                    <option value="Open">Quotation</option>
                    <option value="In Progress">AMC Work </option>
                    <option value="Closed">Non AMC Work</option>
                </select>
            </div>
