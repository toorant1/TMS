...
function generateReportHtml($ticket_id, $ticket_token, $master_userid, $conn) {
...
$html = generateReportHtml($ticket_id, $ticket_token, $master_userid, $conn);
$dompdf->loadHtml($html);
$dompdf->setPaper('A4', 'portrait');
$dompdf->render();

$dompdf->stream("Ticket_Report_{$ticket_id}.pdf", ["Attachment" => true]);
exit;
?>
