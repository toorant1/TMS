...
<body>
    ...
    <div class="container mt-3">
        ...
        <div class="d-flex justify-content-end mb-3">
            ...
            <button id="createQuotationButton"
                class="btn btn-primary"
                data-bs-toggle="modal"
                data-bs-target="#createQuotationModal"
                data-internal-id="<?= htmlspecialchars($internal_id ?? ''); ?>"
        ...
        <!-- Modal for Creating a New Quotation -->
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="quotationModalForm">
                            <div class="mb-3">
                                <label for="internalIDInput" class="form-label">Internal ID</label>
                                <input type="text" class="form-control" id="internalIDInput" name="internal_id" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="tokenInput" class="form-label">Token</label>
                                <input type="text" class="form-control" id="tokenInput" name="token" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="quotationDetailsInput" class="form-label">Additional Details</label>
                                <textarea class="form-control" id="quotationDetailsInput" name="details" placeholder="Enter any additional details"></textarea>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                        <button type="button" class="btn btn-primary" id="saveQuotationButton">Save Quotation</button>
                    </div>
                </div>
            </div>
        </div>
