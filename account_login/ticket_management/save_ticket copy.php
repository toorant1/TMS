...
$ticket_token = generateToken(); // Generate a unique ticket token

// Validate input data
if (
    !$ticket_date || !$ticket_type_id || !$ticket_priority_id || !$ticket_status_id ||
    !$account_id || !$contact_id || !$cause_id || empty($problem_statement)
) {
    echo json_encode(['status' => 'error', 'message' => 'All fields are required.']);
    exit;
}

// Generate ticket_id in the format YEAR-0001
try {
    ...
    // Insert data into the master_tickets table
    $query = "
