...
// Handle AJAX request for filtered tickets
...
<body class="bg-light">
    ...
    <div class="container mt-5">
        <div class="alert alert-primary text-center" role="alert">
            <h1 class="display-5">Welcome back, <strong><?= htmlspecialchars($account['account_name']); ?>!</strong></h1>
            <p class="mb-0">Let us know how we can assist you!</p>
        </div>
    </div>

    <div class="container mt-5">
        <h2 class="text-center mb-4">Ticket Status Summary</h2>
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th style="width: 30%;">Problem Statement</th>
                ...
                button.addEventListener("click", function() {
                    ...
                    fetch("<?= $_SERVER['PHP_SELF']; ?>", {
                        ...
                        .then(data => {
                            ...
                            // Populate table with filtered tickets
                            data.forEach(ticket => {
                                const row = `
                                <tr>
